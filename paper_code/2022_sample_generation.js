...
var CDL_2022=ee.ImageCollection("USDA/NASS/CDL").filterDate('2022-01-01','2022-12-31').first().select('cropland').clip(studyArea)


//maize
var maize_2022=CDL_2022.eq(1).selfMask()
Map.addLayer(maize_2022,{min:1,max:1,palette:['ffd300']},'maize_2022')
//soybean
var soybean_2022=CDL_2022.eq(5).selfMask()
Map.addLayer(soybean_2022,{min:1,max:1,palette:['267000']},'soybean_2022')
//othercrop
var maize_soybean_2022=ee.ImageCollection.fromImages([maize_2022,soybean_2022]).mosaic().rename('label_1').unmask(0).updateMask(Cropland)
var othercrop_2022=maize_soybean_2022.eq(0).selfMask()
Map.addLayer(othercrop_2022,{min:1,max:1,palette:['00a8e2']},'othercrop_2022')
/**************************************************************************
...
***************************************************************************/
      ...
      var NDVI_July=S2.filterDate('2022-07-01','2022-08-01')
      ...
      for(var i=0;i<=10;i++){
        ...
        var maize_mask=neighFun(maize_2022,i,studyArea)
        var inward_maize=maize_2022.updateMask(maize_mask).int16().selfMask()
      ...
      for(var i=0;i<=10;i++){
        ...
        var soybean_mask=neighFun(soybean_2022,i,studyArea)
        var inward_soybean=soybean_2022.updateMask(soybean_mask).int16().selfMask()
...
var maize_mask=neighFun(maize_2022,1,studyArea)
var inward_maize=maize_2022.updateMask(maize_mask).int16().selfMask().rename('Label')

var soybean_mask=neighFun(soybean_2022,1,studyArea)
var inward_soybean=soybean_2022.updateMask(soybean_mask).int16().selfMask().multiply(2).rename('Label')

var othercrop_mask=neighFun(othercrop_2022,0,studyArea)
var inward_othercrop=othercrop_2022.updateMask(othercrop_mask).int16().selfMask().multiply(0).rename('Label')
...
*********************************************************************************/
      ...
      var year = 2022;
      var startDate = ee.Date('2022-05-01'),endDate = ee.Date('2022-10-01'),SY = ee.Date('2022-01-01');
      var interval = 30;
...
*********************************************************************************/
      ...
      var maizesample_purify_2022_withfeature=featureImg.sampleRegions({
      ...
      var soybeansample_purify_2022_withfeature=featureImg.sampleRegions({
      ...
      var othercropsample_purify_2022_withfeature=featureImg.sampleRegions({
